...
public class DiksuchiTripSelect {
	...
	public String toString() {
		return "DiksuchiTripSelect [scheduleID=" + scheduleID + ", currentTripNumber=" + currentTripNumber
				+ ", tripStatus=" + tripStatus + ", routeNumberLength=" + routeNumberLength + ", routeNumber="
				+ routeNumber + ", longitude=" + longitude + ", latitude=" + latitude + ", epochTime=" + epochTime
				+ "]";
	}
